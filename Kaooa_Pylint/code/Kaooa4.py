...
def check_click_crow(x, y):
    """if we click i radius of 60 of the crow then the click is counted and check_click after that"""
    global POS
    global TURN
    TURN = 1
    for point in crows:
...
def check_click(x, y):
    """this functions checks click alternatively and main logic for the game is here checking if the position is empty or valid move or not"""
